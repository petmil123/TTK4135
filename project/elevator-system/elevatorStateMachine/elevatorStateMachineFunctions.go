...
// func getQueueFromOrders(orders state.ElevatorStateStruct) [][]bool {
...
// func handleNetworkOrders(elevator *Elevator, orders state.ElevatorStateStruct, ch StateMachineChannels) {
// 	switch elevator.State {
// 	case Idle:
